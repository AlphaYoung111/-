...
ScrollReveal().reveal('.service-item', { ...scrollAnimateOption, interval: 350 })
...
ScrollReveal().reveal('.data-section', {
  beforeReveal: () => {
    ...
    dataSectionEl.style.backgroundPosition = `center calc(50% - ${dataSectionEl.getBoundingClientRect() / 5}px)`
